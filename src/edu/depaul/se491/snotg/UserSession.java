...
/**
 * This class represents the user's session when using the app.
 * It contains the usr, their selected profile for the session and 
...
public class UserSession 
{
	...
	Location userLoc;
	//TODO CREATE a user status indicator either here or in User object
